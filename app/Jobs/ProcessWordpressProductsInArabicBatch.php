...
class ProcessWordpressProductsInArabicBatch implements ShouldQueue
{
...
//                if ($product['status'] == 'publish'){
                ...
                $woodmart_fbt_bundles = $metaData->firstWhere('key', 'woodmart_fbt_bundles_id');
                $woodmart_fbt_bundles_id = $woodmart_fbt_bundles['value'] ?? [];
...
//                        'woodmart_fbt_bundles_id'=>$woodmart_fbt_bundles_id,
//                        'related_ids' => json_encode($product['related_ids']),
//                        'lang'=>'ar',
//                        'translation_ar'=>$product['translations']['ar'],
//                        'translation_en'=>$product['translations']['en'],
//                    ]
//                );
...
//                            'name' => htmlspecialchars($product['name'], ENT_QUOTES, 'UTF-8'),
                            ...
                            'is_taxable' => $product['tax_status'] == 'taxable' ? 1 : 0,
                            'product_type' => 'physical',
                            'date_on_sale_from' => isset($product['date_on_sale_from'])
                                ? strtotime($product['date_on_sale_from'])
                                : null,
                            'date_on_sale_to' => isset($product['date_on_sale_to'])
                                ? strtotime($product['date_on_sale_to'])
                                : null,
                            'woodmart_fbt_bundles_id' => json_encode($woodmart_fbt_bundles_id ?? []),
                            'related_ids' => json_encode($product['related_ids'] ?? []),
                            'lang' => $product['lang'],
//                        'translation_ar' => is_array($product['translations']['ar'])
//                            ? json_encode($product['translations']['ar'])
//                            : $product['translations']['ar'],
//                        'translation_en' => is_array($product['translations']['en'])
//                            ? json_encode($product['translations']['en'])
//                            : $product['translations']['en'],

                            'total_sales' => (integer)($product['total_sales'] ?? 0),
