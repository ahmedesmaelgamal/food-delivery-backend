...
class Product extends Model
{
    ...
    public function getShippingZones(): HasMany
    {
        return $this->hasMany(ShippingZoneResource::collection(ShippingZone::all()));
    }
    ...
    {
        return $this->hasMany(DigitalProductVariation::class, 'product_id','wordpress_id');
    }
