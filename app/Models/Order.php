...
class Order extends Model
{
    ...
    protected $casts = [
        ...
        'seller_id' => 'integer',
        'seller_is' => 'string',
        'shipping_address_data' => 'array', // Changed from object to array
        'delivery_man_id' => 'integer',
        'deliveryman_charge' => 'double',
        'expected_delivery_date' => 'datetime', // ADDED
        'order_note' => 'string',
        'billing_address' => 'integer',
        'billing_address_data' => 'array', // Changed from object to array
        'order_type' => 'string',
